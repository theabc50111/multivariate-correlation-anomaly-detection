...
target_mats_path_list = ["--target_mats_path pearson/custom_discretize_graph_adj_mat/bins_-10_-03_03_10"]  # ["", "--target_mats_path pearson/custom_discretize_graph_adj_mat/bins_-10_-025_025_10", "--target_mats_path pearson/quan_discretize_graph_adj_mat/bin3"]
...
if set(map(lambda x: x['gru_l'], args_list)) != {""}:
    ...
    model_timedelta_list = [timedelta(hours=1, minutes=40)]
