...
from utils.metrics_utils import (CustomIndicesCrossEntropyLoss,
                                 ...
                                 TolEdgeAccuracyLoss, report_preds_err_rate)
...
if __name__ == "__main__":
    ...
    for fold_idx, (train_dataset, val_dataset, test_dataset) in split_data(model_input_df=model_input_df, target_df=target_df, **split_data_setting).items():
        ...
        if ARGS.train_model is not None:
            ...
            report_preds_err_df_name = f'report_preds_err_rate-{ARGS.inference_data_split}.csv'
            ...
            report_preds_err_rate(model_input_df=model_input_df, tr_val_tt_len_list=tr_val_tt_len_list, inference_data=inference_data, preds=preds, labels=y_labels, data_sp_mode=ARGS.inference_data_split, report_save_path=report_preds_err_df_path)
