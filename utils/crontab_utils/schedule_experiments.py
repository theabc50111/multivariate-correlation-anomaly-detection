...
data_implement_list = ['--data_implement RAND_1_PCA_CLUSTER_PAIRS_1_V2']  # ["", "--data_implement LINEAR_REG_ONE_CLUSTER_DIM_30_BKPS_0_NOISE_STD_30"]
batch_size_list = [""]
...
weight_decay_list = ["", "--weight_decay 0.001", "--weight_decay 0.01"]  # ["--weight_decay 0.0001", "--weight_decay 0.0005", "--weight_decay 0.001", "--weight_decay 0.005", "--weight_decay 0.01", "--weight_decay 0.05", "--weight_decay 0.1"]
...
gru_l_list = ["--gru_l 2"]  # ["--gru_l 1", "--gru_l 2", "--gru_l 3", "--gru_l 4", "--gru_l 5"]
...
attn_num_heads_list = ["--attn_num_heads 1", "--attn_num_heads 2"]  # ["--attn_num_heads 1", "--attn_num_heads 2", "--attn_num_heads 3", "--attn_num_heads 4", "--attn_num_heads 5"]
...
num_models = len(args_list)
model_timedelta_list = [timedelta(hours=1, minutes=0)]
